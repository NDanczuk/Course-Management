    ...
    <div class="container mt-5">
        ...
        <form action="#" method="get">
            <div class="text-center mb-4">
                ...
                <button type="submit" class="btn btn-purple" formaction="report_01.php">Go to report</button>
            </div>
            <div class="text-center mb-4">
                <h3>See the course with the highest number of contents:</h3>
                <button type="submit" class="btn btn-purple" formaction="report_02.php">Go to report</button>
            </div>
            <div class="text-center mb-4">
                <h3>See the list of courses, modules and contents:</h3>
                <button type="submit" class="btn btn-purple" formaction="report_03.php">Go to report</button>
            </div>
            <div class="text-center mb-4">
                <h3>See the list of contents and its respective courses:</h3>
                <button type="submit" class="btn btn-purple" formaction="report_04.php">Go to report</button>
            </div>
            <div class="text-center mb-4">
                <h3>See list of users who watched to class <?php echo $class_02['content_title']?>:</h3>
                <button type="submit" class="btn btn-purple" formaction="report_05.php">Go to list</button>
            </div>
        </form>
    </div>
